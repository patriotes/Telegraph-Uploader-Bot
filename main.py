...
Bot = Client(
    ...
    bot_token=os.environ.get("BOT_TOKEN","6250957785:AAGC5fxr68r1exGAFlRdSsVftyQjCqS2XUQ")
    api_id=int(os.environ.get("API_ID","29984735"))
    api_hash=os.environ.get("API_HASH","c1348b9503c3f869233ae6405e0e0cd8")
)
